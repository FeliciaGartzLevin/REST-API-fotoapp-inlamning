...
export const updateUserRules = [
	...
	body('password').optional().isString().withMessage('Password has to be made up of letters or numbers').isLength({min:6}).withMessage('Password must be at least 3 chars long'),
